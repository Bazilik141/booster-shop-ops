...
class Cart extends \Opencart\System\Engine\Controller {
	...
	public function getList(): string {
		...
		// PAY-002-CANONICAL-STOCK: use the same quantity/option/preorder gate as confirm.
		$has_stock_error = !$this->cart->hasStock();
		...
		$data['pay002_cart_minimum_checkout_blocked'] = !$this->cart->hasMinimum();
...
'minimum_error' => !$product['minimum_status'] ? sprintf($this->language->get('error_minimum'), $product['minimum'], '') : '',
'minimum_value' => (int)$product['minimum'],
