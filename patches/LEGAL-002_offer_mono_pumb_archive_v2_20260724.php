...
const PATCH_NAME = 'LEGAL-002_offer_mono_pumb_archive_v2_20260724';
const LANGUAGE_ID = 4;
...
function bs_run(): void {
    ...
    try {
        ...
        $infoColumns = bs_columns($db, $info); $descColumns = bs_columns($db, $desc);
        ...
        try {
            ...
            if ($archive === null) { $archiveId = bs_insert_information($db, $info, $infoColumns); bs_insert_archive_description($db, $desc, $descColumns, $archiveId, $archiveHtml); bs_insert_route($db, $route, $archiveId); bs_log('created_archive_information_id', (string)$archiveId); }
