...
const PATCH_ID = 'PAY-001_oc4_extension_registry_fix_v2_20260721';
...
$beforePaths = [];
$beforePathsResult = query($db, "SELECT * FROM " . $prefix . "extension_path WHERE extension_install_id='" . $installId . "' ORDER BY extension_path_id ASC");
while ($row = $beforePathsResult->fetch_assoc()) $beforePaths[] = $row;
