...
function setupNewsSheet_() { return { ok: false, retired: true }; }
/* retired 2026-07-03, MKT-TG-005 cleanup — old Make-era pipeline, dead code, no callers remain
const ss = _getCrmSs();
...
*/
function crmGetNewsCandidates_(maxDays) { return []; }
/* retired 2026-07-03, MKT-TG-005 cleanup — dead code, no callers remain
const ss = _getCrmSs();
const sheet = ss.getSheetByName('Новини_кандидати');
if (!sheet) throw new Error('placeholder');
...
function tgCleanNews_(chatId, messageId) { return { archived: 0, retired: true }; }
/* retired 2026-07-03, MKT-TG-005 cleanup — dead code, no callers remain
const ss = _getCrmSs();
const sheet = ss.getSheetByName('Новини_кандидати');
if (!sheet) throw new Error('placeholder');
