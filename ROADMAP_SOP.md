...
series the next free ID is **`CRM-010`** (`CRM-009` was taken on 2026-08-13;
a live query of the whole series returned `CRM-001`…`CRM-008` plus the
non-numeric `CRM-006-ORDER`), and in the `CONTENT-` series
