...
| CRM-008 | П'ять SKU стартових колод OP-16 + закупка лоту `yskh293` | **Читати:** `handoffs/handoff_CRM-008_starter-decks-sku-and-purchase_20260810.md`. Заведено 10.08. Лот `yskh293` (Mercari `m15056144167`): 1 × `OP-JP-OP16-BBX` (SKU уже існує) + 5 нових колод. Рішення власника 10.08: розподіл ₴4 257 = бокс ₴3 000 + по ₴251.40 на колоду; новий формат `Starter Deck`/`STD`; SKU `OP-JP-ST32-STD`…`OP-JP-ST36-STD` без суфікса персонажа; РРЦ ₴700. ⚠ Дві структурні зміни в `Налаштування` (формат + коди сетів ST-32…ST-36) → `OPS-CRMINTEGRITY` діє повністю. ⚠ НЕ ремонтувати `Товари!B/J` — це пас 4 у `CRM-006`. ⚠ Форма закупки бере максимум 3 позиції → два внесення, ¥800 ділиться ¥400/¥400. Notion: `3b86bf20-bdb4-8129-bddf-e002b9e8cd87` |
| CONTENT-005 | Картки товару для 5 стартових колод OP-16 + заливка на сайт | **Читати:** `handoffs/handoff_CONTENT-005_chatgpt-starter-deck-cards_20260810.md` (бриф для ChatGPT, крок 1 готовий). Контентна половина `CRM-008`. Ланцюжок: бриф → чернетки ChatGPT → рев'ю Claude через `bs-content-qa` → технічний хендофф Claude Code на один патч → деплой власника. Рішення власника 10.08: склад колод шукає сам ChatGPT, бриф вимагає джерело під кожен факт, Claude перевіряє кожне посилання на рев'ю. ⚠ Бокс `OP-JP-OP16-BBX` уже має живу активну сторінку в статусі передзамовлення — поза обсягом. Аналог: `plans/new-products-6-skus-2026-06-04.md`. Notion: `3b86bf20-bdb4-81d6-acad-dc7d32b55500` |
