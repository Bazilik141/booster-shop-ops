...
| 3D-P-001 | Номенклатура + облік собівартості/РРЦ (v1 workbook) | 3d-print/3D-P_nomenclature-tracker_v1_20260728.xlsx (див. план §5) |
| 3D-P-002 | Розміщення в каталозі — підкатегорія «Фігурки» (Pokémon) | plans/3D-P-000_scoping-and-architecture_20260728.md §4 (SEO risk-gated) |
