...
| Field | Value |
|---|---|
| Mirror file | `crm/apps-script/Code.gs` — immediately before the MKT-TG-008 change on 2026-08-21, this file was byte-identical after line-ending normalization to the owner-supplied current complete bound source (SHA-256 `da4c5173dae7c9eb39b6d97cf3e2f6bb8a63aa93969d8eeb45eea31fd393b5f2`). It additionally contains the MKT-TG-008 durable Telegram input-state fix, owner-reported deployed as V140. The companion 3D-P mirror is owner-reported live as **V23**. |
| Baseline pulled from live | 2026-08-08, 11:41 Kyiv (owner export `CodeJS - CRM.txt`) |
| **Mirror content deployed to live** | **CRM V140 at 2026-08-21 11:03 Kyiv, owner-reported.** The owner supplied a current complete source that matches the pre-MKT-TG-008 mirror exactly after line-ending normalization, then reported deployment and QA as OK for the MKT-TG-008 change. On 2026-08-22 the owner supplied fresh V140 export `Версія 140, 21 серп. 2026 р., 1103.csv`; normalized comparison to the WP1c CRM candidate is exactly one approved line (the 3D-P component-catalog active-status filter). |
| Deployed Web App version number | **Latest owner-reported: CRM V140 at 2026-08-21 11:03 Kyiv.** The immediately preceding V139 was at 09:47 on 2026-08-21; V133 (2026-08-19 12:24) was byte-compared with the mirror before CRM-010, and 3D-P V23 is owner-reported. |
