...
| Field | Value |
|---|---|
| Mirror file | `crm/apps-script/Code.gs` — local working source is based on owner-reported **CRM V137, 2026-08-20 15:39 Kyiv**, the locally prepared V139 accessory-SKU `apiAddSku_` hunks, and an unpublished CRM-012 follow-up for migration stock reservations and write-offs. V133 was byte-compared with the mirror before CRM-010; the companion 3D-P mirror is owner-reported live as **V23**. |
| Baseline pulled from live | 2026-08-08, 11:41 Kyiv (owner export `CodeJS - CRM.txt`) |
| **Mirror content deployed to live** | **CRM V139 at 2026-08-21 09:47 Kyiv, owner-reported.** The owner reports accessory-SKU deployment, QA and integrity check as OK. No fresh bound-source export or byte comparison was supplied, so this confirms the deployment result but not identity with the complete local mirror; the local CRM-012 follow-up remains unconfirmed as deployed. |
| Deployed Web App version number | **Latest owner-reported: CRM V139 at 2026-08-21 09:47 Kyiv.** The immediately preceding V137 was at 15:39 on 2026-08-20; V133 (2026-08-19 12:24) was byte-compared with the mirror before CRM-010, and 3D-P V23 is owner-reported. |
