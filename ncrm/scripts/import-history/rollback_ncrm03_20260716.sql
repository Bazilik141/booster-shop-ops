-- NCRM-03 round 2 rollback for local batch ncrm03_20260716.
...
and w.note like '%imported_batch=ncrm03_20260716%'
and w.type = 'MBOX';
...
where note like '%imported_batch=ncrm03_20260716%'
and type = 'MBOX';
...
and s.note like '%imported_batch=ncrm03_20260716%';
...
where description like '%imported_batch=ncrm03_20260716%';
